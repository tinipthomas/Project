...
@Component({
  selector: 'app-deletemanagercmt',
  templateUrl: './deletemanagercmt.component.html',
  styleUrls: ['./deletemanagercmt.component.css']
})
export class DeletemanagercmtComponent implements OnInit {
  formData: FormGroup;
